			...
			db.Init("Septavius the Ghost God",
                new State("base",
                    ...
                    new State("spiral",
                        ...
                        new Wander(speed: 0.1f),
                        //new Shoot(radius: 24, count: 3, shootAngle: 15, index: 4, cooldown: 500),
                    ...
                    new State("ring",
                      ...
                      new State("ring2",
                       ...
                       new State("ring3",
                        ...
                        new Spawn("Lair Ghost Paladin", 1, 1),
                        new Spawn("Lair Ghost Warrior", 2, 2),
                        new Shoot(radius: 24, count: 3, shootAngle: 15,predictive:0.40f, index: 4, cooldown: 600),
                        ...
                        new Spawn("Lair Ghost Paladin", 1, 1),
                        new Spawn("Lair Ghost Warrior", 2, 2),
                        new Shoot(radius: 24, count: 3, shootAngle: 15, predictive: 0.50f, index: 4, cooldown: 600),
                    ...
                    new State("quiet",
                       ...
                       new Flash(0x00FF00, 0.25f, 12),
                        new Wander(0.1f),
                        new Shoot(radius: 24, count: 3, shootAngle: 15, index: 2, cooldown: 600),
                ...
                new Threshold(0.0001f,
                    ...
                    new ItemLoot("Doom Bow", 0.004f, damagebased: true),
                    new ItemLoot("Bow of the Morning Star", 0.001f, damagebased: true, threshold: 0.01f),
                    ...
                    new ItemLoot("Duskblade Katana", 0.004f, damagebased: true),
                    new ItemLoot("Interregnum", 0.006f, damagebased: true),
                    new ItemLoot("Toga Picta", 0.006f, damagebased: true),
                    new ItemLoot("Memento Mori", 0.006f, damagebased: true),
                    new ItemLoot("Edictum Praetoris", 0.006f, damagebased: true),
