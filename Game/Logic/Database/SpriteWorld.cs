        ...
        public void Init(BehaviorDb db)
        {
            ...
            db.Init("Limon the Sprite God",
				new State("base",
                    ...
                    new TransitionFrom("base", "start_the_fun"),
         ...
         /* db.Init("Epic Limon the Sprite God",
            new State("base",
                ...
                new ScaleHP(4000, 4000 * 30),
                    new State("1",
                        new Wander(1),
                        new Shoot(50, count: 8, shootAngle: 60, index: 0, predictive: 1, cooldown: 1250),
                        new TimedTransition("2", 11750)
                        ),
                      new State("2",
                          new ConditionalEffect(ConditionEffectIndex.Invincible),
                        new Shoot(50, count: 8, shootAngle: 90, index: 0, predictive: 1, cooldown: 1250),
                         new Shoot(80, count: 4, shootAngle: 90, index: 0, predictive: 4, cooldown: 1250),
                        new TimedTransition("3", 3750)
                          ),
                      new State("3",
                        new Shoot(80, count: 4, shootAngle: 90, index: 0, predictive: 4, cooldown: 1250),
                        new Shoot(85, count: 4, shootAngle: 90, index: 0, predictive: 2, cooldown: 2250),
                        new Shoot(90, count: 4, shootAngle: 90, index: 0, predictive: 1, cooldown: 4250),
                        new TimedTransition("4", 10750)
                            )
                         ),
                   new Threshold(0.01f,
                    new TierLoot(tier: 6, type: LootType.Armor, chance: 0.4f),
                    ...
                    new TierLoot(tier: 5, type: LootType.Ability, chance: 0.0625f),
                    new TierLoot(tier: 3, type: LootType.Ring, chance: 0.25f),
                    new ItemLoot(item: "Potion of Dexterity", chance: 0.3f, numRequired: 3),
                     new ItemLoot(item: "Potion of Dexterity", chance: 1.3f, numRequired: 3),
                      new ItemLoot(item: "Potion of Dexterity", chance: 1.3f, numRequired: 3),
                       new ItemLoot(item: "Potion of Dexterity", chance: 0.3f, numRequired: 3),
                    new ItemLoot(item: "Potion of Defense", chance: 0.1f),
                    new ItemLoot(item: "Sprite Wand", chance: 0.004f, 0, 0.03f),
                    new ItemLoot(item: "Wine Cellar Incantation", chance: 0.05f),
                    new ItemLoot("Mark of Limon", 0, 1),//Sprite Essence
                        new ItemLoot(item: "Sprite World Key", 0.02f),
                        new ItemLoot("50 Credits", 0.01f),
                     new ItemLoot(item: "Sprite Essence", chance: 0.01f, threshold: 0.01f),
                    new ItemLoot(item: "Spriteful Dirk", chance: 0.015f, damagebased: true, threshold: 0.01f),
                    new ItemLoot(item: "Awoken Spriteful Dirk", chance: 0.006f, damagebased: true, threshold: 0.01f),
                    new ItemLoot(item: "Staff of Extreme Prejudice", chance: 0.015f, damagebased: true, threshold: 0.01f),
                    new ItemLoot(item: "Cloak of the Planewalker", chance: 0.015f, damagebased: true, threshold: 0.01f)
                )
            );*/
