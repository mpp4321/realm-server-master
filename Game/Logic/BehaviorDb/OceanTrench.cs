        ...
        public void Init(BehaviorDb db)
        {
            ...
            db.Init("Thessal the Mermaid Goddess",
                ...
                new Threshold(0.1f,
                    ...
                    new ItemLoot("Rune of Elven Magic", 0.02f),
                    new ItemLoot("Coral Venom Trap", 0.08f),
                    new ItemLoot("Wine Cellar Incantation", 0.9f),
            ...
            db.Init("Oyster King",
                    new DropPortalOnDeath("Ancient Hermit Portal", 1.0f),
                    new State("0",
                    ...
                    new ItemLoot("Kingly Pearl", 0.03f, 0.01f)
                );
        }
    }
}