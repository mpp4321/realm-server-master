...
namespace RotMG.Game.Logic.Database
{
    class Highland : IBehaviorDatabase
    {
        public void Init(BehaviorDb db)
        {
            ...
            {
                new TierLoot(4, LootType.Weapon, 0.02f),
                new TierLoot(5, LootType.Weapon, 0.01f),
                new TierLoot(6, LootType.Weapon, 0.005f),
                new TierLoot(4, LootType.Armor, 0.02f),
                new TierLoot(5, LootType.Armor, 0.01f),
                new TierLoot(6, LootType.Armor, 0.005f),
                new TierLoot(2, LootType.Ring, 0.02f),
                new TierLoot(3, LootType.Ring, 0.01f),
                new TierLoot(4, LootType.Ring, 0.005f),
                new TierLoot(2, LootType.Ability, 0.01f),
                new TierLoot(3, LootType.Ability, 0.005f),
            };
            ...
            db.Init("Minotaur",
                new State("base",
                    ...
                    new State("spam_blades",
                        ...
                        new TimedTransition("blade_ring", 3000)
                        ),
            ...
            db.Init("Ogre King",
                    ...
                    new State("grenade_blade_combo",
                        new TransitionFrom("grenade_blade_combo", "grenade1"),
                        new State("grenade1",
                            ...
                            new TimedTransition("grenade2", 2000) { SubIndex = 1 }
                            ),
                        new State("grenade2",
                            new Grenade(3, 60, cooldown: 100000),
                            new Prioritize(
                            ...
                            new TimedTransition("slow_follow", 3000) { SubIndex = 1 }
                            ),
                        new State("slow_follow",
                            ...
                            new TimedTransition("grenade1", 4000) { SubIndex = 1 }
                            ),
            ...
            db.Init("Lizard God",
                ...
                new State("idle",
                    new PlayerWithinTransition(14, "idle"),
                    new Suicide(0),
                ...
                new State("normal_attack",
                    new Shoot(10, 3, 3, predictive: 0.5f, cooldown: 500),
                ...
                new State("if_cloaked",
                    ...
                    new Prioritize(
                        new StayAbove(0.3f, 160),
                        new Follow(0.5f, range: 7, duration: 500, cooldown: 250),
                        new Wander(0.4f)
                        )
                ),
                new TierLoot(5, LootType.Weapon, 0.16f),
            ...
            db.Init("Undead Dwarf God",
                ...
                new State("fight",
                    ...
                    new Shoot(10, index: 0, count: 3, shootAngle: 15, cooldown: 350),
            ...
            db.Init("Flamer King",
                new State("base",
                    new Spawn("Flamer", 5, cooldown: 4000),
                    new State("Attacking",
                        new State("Charge",
            ...
            db.Init("Flamer",
                new StayBack(0.5f, 0.75f, "Flamer"),
                new State("base",
                    new State("Attacking",
                        new State("Charge",
                            new Prioritize(
                                new Protect(0.7f, "Flamer King"),
                                new Follow(1.2f, range: 0.1f)
                                ),
                            new PlayerWithinTransition(2, "Bullet")
                            ),
                        new State("Bullet",
            ...
            db.Init("Juvenile White Dragon",
                new State("base",
                    new Shoot(10, 2, 20, predictive: 0.4f, cooldown: 650),
                    new Prioritize(
                        new StayAbove(9, 150),
            ...
            db.Init("Adult White Dragon",
                new State("base",
                    new Shoot(10, 3, 15, predictive: 0.5f, cooldown: 550),
                    new Prioritize(
                        new StayAbove(9, 150),
                ...
                new State("base",
                    ...
                    new State("Attacking",
                        new State("Attack",
                            ...
                            new HealthTransition(0.5f, "Heal") { SubIndex = 1 },
                            new EntitiesNotExistsTransition(7, "Idling", "Shield Orc Key")
                            ),
                        new State("Heal",
                            new HealEntity(7, "Shield Orc Shield", 500),
                            new HealEntity(7, "Shield Orc Flooder", 500),
                            new TimedTransition("Attack", 500) { SubIndex = 1 },
                            new EntitiesNotExistsTransition(7, "Idling", "Shield Orc Key")
                            )
                        ),
                    new State("Flash",
            ...
            db.Init("Shield Orc Key",
                new State("base",
                    new Spawn("Shield Orc Flooder", 2, 2, 10000),
                    new Spawn("Shield Orc Shield", 2, 2, 10000),
                    new Spawn("Shield Orc Shield", 2, 2, 10000),
                    new TransitionFrom("base", "Start"),
                    new State("Start",
                        new TimedTransition("Attacking", 500) {  SubIndex = 1 }
                        ),
                    new State("Attacking",
                        new Orbit(1, 3, target: "Shield Orc Flooder"),
                        new Order(7, "Shield Orc Flooder", "Attacking"),
                        new Order(7, "Shield Orc Shield", "Attacking"),
                        new HealthTransition(0.5f, "FlashBeforeExplode") { SubIndex = 1 }
                        ),
                    new State("FlashBeforeExplode",
                        new Order(7, "Shield Orc Flooder", "Flash"),
                        new Order(7, "Shield Orc Shield", "Flash"),
                        new Flash(0xff0000, 1, 1),
                        new TimedTransition("Explode", 300) { SubIndex = 1 }
                        ),
                    new State("Explode",
                        new Shoot(0, 10, 36, fixedAngle: 0),
                        new Decay(0)
