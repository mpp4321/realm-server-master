        ...
        public void Init(BehaviorDb db)
        {
            ...
            db.Init("Horrific Creation",
                ...
                new State("base",
                    ...
                    new Threshold(0.01f,
                        new ItemLoot("Conducting Wand", 0.02f, threshold: 0.01f),
                        new ItemLoot("Experimental Ring", 0.02f, threshold: 0.01f),
                        new ItemLoot("Horrific Spear", 0.02f, threshold: 0.01f),
                        new ItemLoot("Realm Equipment Crystal", 0.1f),
                        new ItemLoot("Wine Cellar Incantation", 0.05f),
                        new ItemLoot("Potion of Wisdom", 1.0f),
                        new ItemLoot("Potion of Defense", 0.8f, 0.5f),
                        new ItemLoot("Potion of Life", 0.1f, 0.5f),
