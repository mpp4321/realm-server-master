        ...
        public void Init(BehaviorDb db)
        {
            db.Init("Tomb Defender",
                    ...
                    new State("artifacts",
                        ...
                        new Shoot(12, 3, 10, 1, cooldown: 6000, predictive: 0.6f),
                        new Spawn("Pyramid Artifact 1", 3, 1, 0, cooldown: 0),
                        new Spawn("Pyramid Artifact 2", 2, 1, 0, cooldown: 0),
                        new Spawn("Pyramid Artifact 3", 1, 1, 0, cooldown: 0),
                    ...
                    new State("rage",
                        ...
                        new Spawn("Pyramid Artifact 1", 3, 1, cooldown: 0),
                        new Spawn("Pyramid Artifact 2", 2, 1, cooldown: 0),
                        new Spawn("Pyramid Artifact 3", 2, 1, cooldown: 0),
                ...
                new Threshold(0.0001f,
                    ...
                    new ItemLoot("Sand Monster Contract", 0.01f),
                    new TierLoot(10, TierLoot.LootType.Armor, 1.0f, r: new(1.0f, 1, true))
            ...
            db.Init("Tomb Support",
                new State("base",
                    ...
                    new State("artifacts",
                        ...
                        new Spawn("Sphinx Artifact 1", 3, 1, 0, cooldown: 0),
                        new Spawn("Sphinx Artifact 2", 3, 1, 0, cooldown: 0),
                        new Spawn("Sphinx Artifact 3", 3, 1, 0, cooldown: 0),
                    ...
                    new State("double shoot",
                        ...
                        new Spawn("Sphinx Artifact 1", 3, 1, 0, cooldown: 0),
                        new Spawn("Sphinx Artifact 2", 3, 1, 0, cooldown: 0),
                        new Spawn("Sphinx Artifact 3", 3, 1, 0),
                        new HealthTransition(.06f, "rage")
                    ),
                    new State("rage",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable, duration: 2000),
            ...
            db.Init("Tomb Attacker",
                    ...
                    new State("lets dance",
                        ...
                        new Grenade(4, 120, 10, cooldown: 6000),
                        new Spawn("Scarab", 4, 1, 0.1f , cooldown: 10000),
                    ...
                    new State("artifacts",
                        ...
                        new Spawn("Scarab", 4, 1, 0.1f , cooldown: 10000),
                        new Spawn("Nile Artifact 1", 2, 1, 0, cooldown: 0),
                        new Spawn("Nile Artifact 2", 2, 1, 0, cooldown: 0),
                        new Spawn("Nile Artifact 3", 2, 1, 0, cooldown: 0),
