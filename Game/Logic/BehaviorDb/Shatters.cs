...
{
    internal class Shatters : IBehaviorDatabase
    {
        ...
        #region generators
            ...
            db.Init("shtrs Bridge Obelisk A",
                new State("base",
                    ...
                    new State("Pause",
                        new ConditionalEffect(ConditionEffectIndex.Invulnerable, duration: 100),
        ...
        db.Init("shtrs Bridge Closer",
            new State("base",
                ...
                new State("Closer",
                    new ChangeGroundOnEnter(Region.Decoration1, "shtrs Pure Evil")
                    ),
                new State("Closer2",
                    new ChangeGroundOnEnter(Region.Decoration2, "shtrs Pure Evil")
                    ),
                new State("Closer3",
                    new ChangeGroundOnEnter(Region.Decoration3, "shtrs Pure Evil")
                    ),
                new State("Closer4",
                    new ChangeGroundOnEnter(Region.Decoration4, "shtrs Pure Evil"),
                ...
                new State("TwilightClose",
                    //new ChangeGroundOnDeath("shtrs Shattered Floor", "shtrs Disaster Floor" }, new[] { "shtrs Pure Evil" }),
                    new ChangeGroundOnEnter(Region.Store1, "shtrs Pure Evil")
                    ),
                new State("TwilightClose2",
                    //new ChangeGroundOnDeath("shtrs Shattered Floor", "shtrs Disaster Floor" }, new[] { "shtrs Pure Evil" }),
                    new ChangeGroundOnEnter(Region.Store2, "shtrs Pure Evil")
                    ),
                new State("TwilightClose3",
                    //new ChangeGroundOnDeath("shtrs Shattered Floor", "shtrs Disaster Floor" }, new[] { "shtrs Pure Evil" }),
                    new ChangeGroundOnEnter(Region.Store3, "shtrs Pure Evil")
                    ),
                new State("TwilightClose3",
                    //new ChangeGroundOnDeath("shtrs Shattered Floor", "shtrs Disaster Floor" }, new[] { "shtrs Pure Evil" }),
                    new ChangeGroundOnEnter(Region.Store4, "shtrs Pure Evil")
                    )
                )
            );
        ...
        //            ),
        //        new State("Closer",
        //            new ChangeGroundOnDeath(Region.Decoration2, "shtrs Pure Evil"),
        //            //new ChangeGroundOnDeath(new[] { "shtrs Bridge" }, new[] { "shtrs Pure Evil" },
        //            //    1),
        //            new Suicide()
        //            ),
        //        new State("TwilightClose",
        //            new ChangeGroundOnDeath(Region.Store2, "shtrs Pure Evil"),
        ...
        //            ),
        //        new State("Closer",
        //            new ChangeGroundOnDeath(Region.Decoration3, "shtrs Pure Evil"),
        //            //new ChangeGroundOnDeath(new[] { "shtrs Bridge" }, new[] { "shtrs Pure Evil" },
        //            //    1),
        //            new Suicide()
        //            ),
        ...
        //            //new ChangeGroundOnDeath(new[] { "shtrs Shattered Floor", "shtrs Disaster Floor" }, new[] { "shtrs Pure Evil" },
        //            //    1),
        //            new ChangeGroundOnDeath(Region.Store3, "shtrs Pure Evil"),
        //            new Suicide()
        ...
        //            ),
        //        new State("Closer",
        //            new ChangeGroundOnDeath(Region.Decoration4, "shtrs Pure Evil"),
        //            //new ChangeGroundOnDeath(new[] { "shtrs Bridge" }, new[] { "shtrs Pure Evil" },
        //            //    1),
        //            new Suicide()
        //            ),
        ...
        //            //new ChangeGroundOnDeath(new[] { "shtrs Shattered Floor", "shtrs Disaster Floor" }, new[] { "shtrs Pure Evil" },
        //            //    1),
        //            new ChangeGroundOnDeath(Region.Store4, "shtrs Pure Evil"),
        //            new Suicide()
        ...
        db.Init("shtrs Spawn Bridge",
            new State("base",
                ...
                new State("Open",
                    ...
                    //    1),
                    new ChangeGroundOnDeath(Region.Decoration5, "shtrs Bridge"),
                    new Suicide()
                    )
                )
            );
        ...
        db.Init("shtrs Spawn Bridge 5",
            new State("base",
                ...
                new State("Open",
                    ...
                    //    1),
                    new ChangeGroundOnDeath(Region.Note, "Hot Lava"),
                    new Suicide()
                    )
                )
            );
                ...
                new State("base",
                    ...
                    new State("fireandice",
                     ...
                     new State("middle",
                        ...
                        new State("heheh",
                            new ConditionalEffect(ConditionEffectIndex.Invincible, duration: 100),
                            new ConditionalEffect(ConditionEffectIndex.Invisible, duration: 100),
                            new ConditionalEffect(ConditionEffectIndex.Stasis, duration: 100),
                            new Taunt("Ha... haa..."),
            ...
            db.Init("shtrs Royal Guardian J",
                new State("base",
                    new State("shoot",
                        ...
                        new Shoot(15, 8, index: 0, cooldown: 3600, cooldownVariance: 3600)
                        )
                    )
            );
            ...
            db.Init("shtrs Green Crystal",
                new State("base",
                    new HealEntity(30, "Crystals", cooldown: 2000, healAmount: 1500),
                    new State("spawn",
                        new ConditionalEffect(ConditionEffectIndex.Invincible),
        ...
        db.Init("shtrs king lava1",
            new State("base",
                 ...
                 new State("lava",
                    new ReplaceTileNearby("Dark Cobblestone", "Hot Lava", 30)
                 ),
                 new State("death",
                     new Suicide()
                 )
